<template>
  <div class="page-container" style="padding-top: 20px">
    <div>
      <el-button type="danger" @click="addBrokerClick">添加全职客户经理</el-button>
    </div>
    ...
    >
      <el-form ref="broderForm" :model="counselor" :rules="counselorRules" label-width="120px">
        <el-form-item label="绑定服务主管" prop="ownCounselorId">
...
export default {
  ...
  methods: {
    getCharge(type) {
      ...
      const params = { marketType: '01', status }
