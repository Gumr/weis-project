    ...
    <div>
      <div v-show="activeTab === 0">
        ...
        <div class="detail-section  display-flex">
          <div>
            <span class="section-label">全职客户经理名称：</span>
        ...
        <div class="detail-section  display-flex">
          <div>
            <span class="section-label">全职客户经理手机：</span>
      ...
      <div v-show="activeTab === 1">
        ...
        <div style="margin: 12px 0;">
          当前绑定兼职客户经理人数<span class="count-label">{{
            subTable.total
          }}</span>
        </div>
...
export default {
  ...
  methods: {
    ...
    getCounselorDetail() {
      this.$request('Channel/queryAgentDetail', { id: this.id, marketType: '01' }).then(
        this.$rw((err, res) => {
          if (!err) {
