    ...
    <div>
      <div v-show="activeTab === 0">
        ...
        <div class="detail-section display-flex">
          <div>
            <span class="section-label">兼职客户经理ID：</span>
        ...
        <div class="detail-section  display-flex">
          <div>
            <span class="section-label">兼职客户经理名称：</span>
        ...
        <div class="detail-section  display-flex">
          <div>
            <span class="section-label">兼职客户经理手机：</span>
            <span>{{ counselor.counselorPhone || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定全职客户经理ID：</span>
            <span>{{ counselor.parentCounselorId || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定全职客户经理名称：</span>
            <span>{{ counselor.parentCounselorName || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定全职客户经理手机：</span>
            <span>{{ counselor.parentCounselorPhone || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定服务主管ID：</span>
            <span>{{ counselor.ownManagerId  || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定服务主管名称：</span>
            <span>{{ counselor.ownManagerName  || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定服务主管手机：</span>
        ...
        <div class="detail-section">
          <div>
            <span class="section-label">申请成为兼职客户经理时间：</span>
...
export default {
  ...
  methods: {
    getCounselorDetail() {
      this.$request('Channel/queryAgentDetail', { counselorId: this.counselorId, marketType: '01' }).then(
        this.$rw((err, res) => {
          if (!err) {
