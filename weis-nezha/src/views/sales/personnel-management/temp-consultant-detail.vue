      ...
      <div v-show="activeTab === 0">
        ...
        <div class="detail-section display-flex">
          <div class="info-item" style="width: 40%;">
            ...
            <span>{{ counselor.tsePhone }}</span>
          </div>
          <div class="info-item">
            <span class="section-label section-label-2">当前上级姓名：</span>
            <span>{{ counselor.tseParentName }}</span>
          </div>
        </div>
        <div class="detail-section display-flex">
          <div class="info-item" style="width: 40%;">
            <span class="section-label">身份证号：</span>
            <span>{{ counselor.tseIdCard }}</span>
          </div>
          <div class="info-item">
            <span class="section-label section-label-2">当前上级ID：</span>
            <span>{{ counselor.tseParentId }}</span>
          </div>
        </div>
        <div class="detail-section display-flex">
          <div class="info-item" style="width: 40%;">
            <span class="section-label">邮箱地址：</span>
            <span>{{ counselor.tseEmail }}</span>
          </div>
          <div class="info-item">
            <span class="section-label section-label-2">当前上级手机：</span>
            <span>{{ counselor.tseParentPhone }}</span>
          </div>
        </div>
        <div class="info-item detail-section display-flex">
          ...
          <div class="image-box-wrap">
            <div
              ...
              :key="index"
            >
              <el-image class="certificate-img" :preview-src-list="[img]" :src="img"></el-image>
            </div>
          </div>
        </div>
      ...
      <div v-show="activeTab === 1">
        ...
        >
          <template v-slot:action>
            <el-button type="priamry" @click="getMemberTableData">搜索</el-button>
          </template>
        </QueryComponents>
        ...
        <el-table :data="memberTable.data" border stripe>
          <el-table-column v-for="(col, index) in memberTable.col" :key="index" v-bind="col"></el-table-column>
        </el-table>
      </div>
