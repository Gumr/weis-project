    ...
    <div>
      <div v-show="activeTab === 0">
        ...
        <div class="detail-section display-flex">
          <div>
            <span class="section-label">兼职营养师ID：</span>
        ...
        <div class="detail-section  display-flex">
          <div>
            <span class="section-label">兼职营养师名称：</span>
        ...
        <div class="detail-section  display-flex">
          <div>
            <span class="section-label">兼职营养师手机：</span>
            <span>{{ counselor.counselorPhone || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定营养师ID：</span>
            <span>{{ counselor.parentCounselorId || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定营养师名称：</span>
            <span>{{ counselor.parentCounselorName || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定营养师手机：</span>
            <span>{{ counselor.parentCounselorPhone || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定营养师主管ID：</span>
            <span>{{ counselor.ownManagerId  || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定营养师主管名称：</span>
            <span>{{ counselor.ownManagerName  || '无' }}</span>
          </div>
        </div>
        <div class="detail-section">
          <div>
            <span class="section-label">绑定营养师主管手机：</span>
        ...
        <div class="detail-section">
          <div>
            <span class="section-label">申请成为兼职营养师时间：</span>
...
export default {
  ...
  methods: {
    getCounselorDetail() {
      this.$request('Channel/queryAgentDetail', { counselorId: this.counselorId, marketType: '03' }).then(
        this.$rw((err, res) => {
          if (!err) {
