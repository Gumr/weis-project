<template>
  <div class="page-container">
    <div style="margin: 20px 0;display: flex;">
      <QueryComponents v-model="queryParams" :query-list="queryComps" :span="6" :label-width="90">
        <template #action>
      ...
      <el-button type="primary" @click="createManager">添加兼职营养师</el-button>
    </div>
    <BasePageTable
      ref="table"
    ...
    >
      <div>
        <div class="section-item">
          <span class="section-label label-1">上级全职营养师：</span>
          <BaseSelect
...
export default {
  // name: 'sales_medical_review-list',
  components: {
    QueryComponents,
    BasePageTable,
    ConfirmDialog
  ...
  methods: {
    async getCharge() {
      const params = { marketType: '03', channel: '02', status: '03' }
    ...
    // 添加兼职客户经理
    async getCounselor() {
      const res = await this.$http('Channel/queryOwnCounselor', { marketType: '03', channel: '02', status: '03' })
